            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a class="nav-link" href="index_kategori.php"><i class="fas fa-columns"></i>Kategori</a></li>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_kategori.php?id=<?= $row['id'] ?>" class="btn btn-warning">
                                                                Edit
                                                            </a>
                                                            <a href="hapus_kategori.php?id=<?= $row['id'] ?>" class="btn btn-danger">
                                                                Hapus
                                                            </a>
                                                        </td>
                                                    </tr>
