                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = 'SELECT a.*, b.nama_kategori as kategori FROM tb_produk a 
                                                        JOIN tb_kategori b 
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['harga'] ?></td>
                                                        <td>
                                                            <a href="edit_produk.php?id=<?= $row['id'] ?>" class="btn btn-warning">
                                                                Edit
                                                            </a>
                                                            <a href="hapus_produk.php?id=<?= $row['id'] ?>" class="btn btn-danger">
                                                                Hapus
                                                            </a>
                                                        </td>
                                                    </tr>
